    ...
    <div class="mb-6">
      <div class="relative">
        <img
          ...
          style="width: 408px; height: 208px"
          loading="lazy"
        />
        <div class="flex gap-5 absolute bottom-9 left-2">
          <div v-if="discount" class="bg-yellow-400 tio px-2 py-1 rounded">
            <span class="text-sm">{{ discount }}</span>
          </div>
          <div class="flex items-center gap-2 bg-white rounded px-5 py-1">
            <svg
              width="11"
              height="13"
              viewBox="0 0 11 13"
